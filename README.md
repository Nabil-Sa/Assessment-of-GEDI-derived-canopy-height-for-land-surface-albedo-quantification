...
where $P_{\text{gap}}(z + \Delta z, \theta)$ accounts for the gap probability above the current layer, $F_{\text{app}}(z)$ represents the foliage profile intercepting light at height $z$. 

$$F_{\text{app}}(z) = \lim_{\Delta z \to 0} -\frac{P_{\text{gap}}(z+\Delta z, \theta) - P_{\text{gap}}(z, \theta)}{P_{\text{gap}}(z, \theta) \cdot \left(\frac{\Delta z}{\cos \theta}\right)} = \lim_{\Delta z \to 0} -\frac{\Delta P_{\text{gap}}(z, \theta)}{P_{\text{gap}}(z, \theta) \cdot \left(\frac{\Delta z}{\cos \theta}\right)} = -\frac{d \ln \{P_{\text{gap}}(z, \theta)\}}{dz / \cos \theta}$$
